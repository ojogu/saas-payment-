...
class Accounts(BaseModel):
    ...
    account_points: Mapped[List["AccountPoints"]] = relationship(back_populates="account", cascade="all, delete-orphan")
    clearance_items: Mapped[List["ClearanceItem"]] = relationship(back_populates="account", lazy=True, cascade="all, delete-orphan")  # noqa: F821 # type: ignore
...
class AccountPoints(BaseModel):
    ...
    id: Mapped[int] = mapped_column(Integer, primary_key=True)
    clearance_point_id: Mapped[int] = mapped_column(
    ...
    # Relationships
    clearance_point: Mapped["ClearancePoint"] = relationship(back_populates="account_points")  # noqa: F821 # type: ignore
...
class PassivePayment(BaseModel):
    ...
    # Relationships
    clearance_item: Mapped["ClearanceItem"] = relationship(back_populates="passive_payments")  # noqa: F821 # type: ignore
